<template>
  <div class="pageProportionsearch">
      ...
      <div class="box">
        <form class="form-inline">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail3" placeholder="输入账号" v-model="num">
          </div>
          <div class="form-group">
            <label class="" for="exampleInputPassword3">昵称:</label>
            <input type="name" class="form-control" id="exampleInputPassword3" placeholder="输入昵称" v-model="name">
          </div>
          <div class="form-group">
            <label class="" for="exampleInputPassword4">手机号码</label>
            <input type="text" class="form-control" id="exampleInputPassword4" placeholder="输入手机号码" v-model="phone">
          </div>
          <div class="form-group">
            <label class="" for="exampleInputPassword3">账号状态</label>
            <select class="form-control sel" v-model="selstatus">
              <!-- <option>全部</option> -->
            ...
            <table class="table table-bordered table-striped text-center" style="position:relative">
              ...
              <tbody>
                <tr v-for="(user,index) in datalist" :key='index' @click="add(user,index,$event)">
                  <td>
                    <input type="checkbox" v-model="user.check" @click="checked(user)">
                  </td>
                  <td>{{user.id}}</td>
          ...
          <div class="addformbox" style="display:none;">
            <form class="layui-form" action="" style="">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="password" name="pwd" v-model="addarr.password" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
...
<script>
  // import tabledemo from '../components/extendtable.vue';
  import Vue from 'vue';
  ...
  export default {
    ...
    methods: {
      ...
      insert: function (index) {
        ...
        $('.addformbox form').on('submit(*)', function (data) {
