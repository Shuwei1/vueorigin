      ...
      <div class="box">
        <form class="form-inline">
          <div class="form-group">
            <label class="" for="exampleInputEmail3">账号:</label>
            <input type="text" class="form-control" id="exampleInputEmail3" placeholder="输入账号" v-model="user_login">
          </div>
          <div class="form-group">
            <label class="" for="exampleInputPassword3">昵称:</label>
            <input type="name" class="form-control" id="exampleInputPassword3" placeholder="输入昵称" v-model="user_name">
          </div>
          <div class="form-group">
            <label class="" for="exampleInputPassword4">手机号码</label>
            <input type="text" value="1111" class="form-control" id="exampleInputPassword4" placeholder="输入手机号码" v-model="phone">
          </div>
          <div class="form-group">
            <label class="" for="exampleInputPassword3">账号状态</label>
            <select class="form-control sel" v-model="user_status">
              <option value='1'>正常</option>
              <option value="2">冻结</option>>
            </select>
          </div>
          <button type="submit" class="btn btn-success" @click="query()">
          ...
          <div class="add">
            <span class="l">
              <a href="javascript:;" @click="insert" class="btn btn-primary radius" style="color:white;margin:10px 0;">
                <i class="layui-icon" style="color:white">&#xe654;</i> 添加组长</a>
            </span>
          </div>
            ...
            <table class="table table-bordered table-striped text-center" style="position:relative">
              ...
              <tbody>
                <tr v-for="(user,index) in datalist" :key='index' @click="add(user,index,$event)">
                  <td>
                    <input type="checkbox" v-model="user.checked" @click="checked(user)">
                  </td>
                  <td>{{user.id}}</td>
          ...
          <div class="addformbox" style="display:none;">
            <form class="layui-form" action="" style="">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="password" name="pwd" v-model="addarr.password" class="layui-input addpass">
                </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
            ...
            <form class="layui-form" action="" style="">
              ...
              <div class="layui-form-item" style="display:flex;align-item:center;">
                ...
                <div class="layui-input-inline">
                  <input type="checkbox" style="width:15px;color:red;height:15px;margin-left:30px;margin-top:12px;" value="" :checked='check'>
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">组长</label>
                <div class="layui-input-block">
                  <select name="city" v-model="selitem">
                    <option value="">请选择组长</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
              ...
              <div class="layui-form-item">
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="text" name="selectedlist.name" v-model="selectedlist.user_login" placeholder="请输入标题" class="layui-input resettext">
              ...
              <span class="errortip" v-show="errors.has('sa')">{{ errors.first('sa') }}</span> -->
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="text" name="selectedlist.user_name" v-model="selectedlist.user_name" placeholder="请输入标题" class="layui-input resetname">
    ...
    methods: {
      ...
      query() {
        ...
        var user_id = {
          ...
          api_token: localStorage.getItem('api_token'),
          user_type: '2',
          user_login: vm.user_name,
          user_name: vm.user_login,
          phone: vm.phone,
          user_status: vm.user_status,
          page: vm.pageIndex,
          per_page: vm.pageSize
        }
        vm.user_id = user_id;
      ...
      modify(user, index) {
        let vm = this;
        let resettext = $('.resettext').val();
        let resetname = $('.resetname').val();
        let resetphone = $('.resetphone').val();
        let resetemail = $('.resetemail').val();
        console.log(resettext)
        this.isActive = false;
        Vue.set(vm.datalist, vm.selected, {
          'id': vm.selectedlist.id,
          'user_name': resetname,
          'user_login': resettext,
          "phone": resetphone,
          'user_email': resetemail,
          'create_time': vm.selectedlist.create_time,
          'last_login_time': vm.selectedlist.last_login_time,
          'user_status': 1
        });
      },
      ...
      submit(user, index) {
        ...
        let add_id = {
          ...
          api_token: localStorage.getItem('api_token'),
          user_type: 2,
          user_login: vm.addarr.user_login,
