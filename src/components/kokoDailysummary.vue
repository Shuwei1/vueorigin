<template>
  <div class="pageDailysummar">
    ...
    <div class="addbox">
      ...
      <div class="pag">
        <v-pagination :total="1000" :page-size="30" @page-change="pageChange(pageIndex)" :page-index='pageIndex' @page-size-change="pageSizeChange"
